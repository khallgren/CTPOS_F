...
Public Class frmInvCategories
    ...
    Public Sub FillGrid()
        ...
        Dim strSQL = "Select * from tblInvCodeCategory ORDER BY strInvCategory;"
    ...
    Private Sub UpdateRecords()
        ...
        Try
            ...
            For iCount = 0 To iRowsCount - 1
                ...
                strSQL = "UPDATE tblInvCodeCategory SET strInvCategory = " + "'" + Replace(szAdjType, "'", "''") + "'" + " WHERE lngInvCategoryID = " + iSecondColumn.ToString()
    ...
    Private Sub InsertRecords()
        ...
        Try
            ...
            While iRowsToInsert > 1
                ...
                strSQL = "INSERT INTO tblInvCodeCategory (strInvCategory, blnPrintRecpt) VALUES ( " + strNewValue + ",1)"
