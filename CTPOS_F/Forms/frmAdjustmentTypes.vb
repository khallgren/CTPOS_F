...
Public Class frmAdjustmentTypes
    ...
    Public Sub FillGrid()
        ...
        Try
            ...
            Dim strSQL = "Select * from tlkpAdjustmentType ORDER BY strAdjustmentType;"
    ...
    Private Sub UpdateRecords()
        ...
        Try
            ...
            For iCount = 0 To iRowsCount - 1
                ...
                strSQL = "UPDATE tlkpAdjustmentType SET strAdjustmentType = " + "'" + szAdjType + "'" + " WHERE lngAdjustmentTypeID = " + iSecondColumn.ToString()
    ...
    Private Sub InsertRecords()
        ...
        Try
            ...
            While iRowsToInsert > 1
                ...
                strSQL = "INSERT INTO tlkpAdjustmentType (strAdjustmentType) VALUES (" + strNewValue + ")"
