...
Public Class rptStoreSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTPOS_F.rptStoreSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStoreSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStoreSummary = New rptStoreSummary
        rpt.Site = Me.Site
        Return rpt
    End Function
