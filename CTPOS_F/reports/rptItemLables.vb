...
Public Class rptItemLables
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTPOS_F.rptItemLables.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptItemLables
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptItemLables = New rptItemLables
        rpt.Site = Me.Site
        Return rpt
    End Function
