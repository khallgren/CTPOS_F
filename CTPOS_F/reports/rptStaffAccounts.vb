...
Public Class rptStaffAccounts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTPOS_F.rptStaffAccounts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStaffAccounts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStaffAccounts = New rptStaffAccounts
        rpt.Site = Me.Site
        Return rpt
    End Function
