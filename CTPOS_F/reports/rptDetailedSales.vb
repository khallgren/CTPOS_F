...
Public Class rptDetailedSales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTPOS_F.rptDetailedSales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetailedSales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetailedSales = New rptDetailedSales
        rpt.Site = Me.Site
        Return rpt
    End Function
