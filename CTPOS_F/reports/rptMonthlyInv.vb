...
Public Class rptMonthlyInv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTPOS_F.rptMonthlyInv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMonthlyInv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMonthlyInv = New rptMonthlyInv
        rpt.Site = Me.Site
        Return rpt
    End Function
