...
Public Class rptCraftSheetBlank
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTPOS_F.rptCraftSheetBlank.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCraftSheetBlank
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCraftSheetBlank = New rptCraftSheetBlank
        rpt.Site = Me.Site
        Return rpt
    End Function
