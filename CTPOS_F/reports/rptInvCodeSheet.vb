...
Public Class rptInvCodeSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTPOS_F.rptInvCodeSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvCodeSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvCodeSheet = New rptInvCodeSheet
        rpt.Site = Me.Site
        Return rpt
    End Function
