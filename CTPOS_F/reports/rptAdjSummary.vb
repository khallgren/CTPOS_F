...
Public Class rptAdjSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTPOS_F.rptAdjSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAdjSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAdjSummary = New rptAdjSummary
        rpt.Site = Me.Site
        Return rpt
    End Function
