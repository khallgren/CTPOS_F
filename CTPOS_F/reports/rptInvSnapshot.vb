...
Public Class rptInvSnapshot
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTPOS_F.rptInvSnapshot.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvSnapshot
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvSnapshot = New rptInvSnapshot
        rpt.Site = Me.Site
        Return rpt
    End Function
