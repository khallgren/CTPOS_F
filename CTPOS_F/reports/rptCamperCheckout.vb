...
Public Class rptCamperCheckout
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTPOS_F.rptCamperCheckout.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_parSort() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCamperCheckout
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCamperCheckout = New rptCamperCheckout
        rpt.Site = Me.Site
        Return rpt
    End Function
