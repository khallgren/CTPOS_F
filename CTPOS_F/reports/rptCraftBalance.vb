...
Public Class rptCraftBalance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CTPOS_F.rptCraftBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCraftBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCraftBalance = New rptCraftBalance
        rpt.Site = Me.Site
        Return rpt
    End Function
